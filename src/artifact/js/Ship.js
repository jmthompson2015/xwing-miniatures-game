...
define(["artifact/js/FiringArc", "artifact/js/Maneuver", "artifact/js/Range", "artifact/js/ShipAction", "artifact/js/ShipBase"],
   function(FiringArc, Maneuver, Range, ShipAction, ShipBase)
   {
      var Ship = {
        ...
        Maneuver.STRAIGHT_4_STANDARD, Maneuver.KOIOGRAN_TURN_4_HARD],
            ...
            "auzituckgunship":
            {
               ...
               shieldValue: 3,
               shipBaseKey: ShipBase.SMALL,
               auxiliaryFiringArcKey: FiringArc.FORWARD_180,
               maneuverKeys: [Maneuver.BANK_LEFT_1_EASY, Maneuver.STRAIGHT_1_EASY, Maneuver.BANK_RIGHT_1_EASY,
        Maneuver.TURN_LEFT_2_STANDARD, Maneuver.BANK_LEFT_2_STANDARD, Maneuver.STRAIGHT_2_EASY, Maneuver.BANK_RIGHT_2_STANDARD, Maneuver.TURN_RIGHT_2_STANDARD,
        ...
        Maneuver.STRAIGHT_5_STANDARD, Maneuver.KOIOGRAN_TURN_5_HARD],
            ...
            "m12lkimogilafighter":
            {
               ...
               shieldValue: 2,
               shipBaseKey: ShipBase.SMALL,
               auxiliaryFiringArcKey: FiringArc.BULLSEYE,
        ...
        Maneuver.STRAIGHT_5_STANDARD],
            ...
            "quadjumper":
            {
               ...
               shieldValue: 0,
               shipBaseKey: ShipBase.SMALL,
               maneuverKeys: [Maneuver.REVERSE_BANK_LEFT_1_HARD, Maneuver.REVERSE_STRAIGHT_1_HARD, Maneuver.REVERSE_BANK_RIGHT_1_HARD,
        Maneuver.TURN_LEFT_1_STANDARD, Maneuver.STRAIGHT_1_STANDARD, Maneuver.TURN_RIGHT_1_STANDARD,
      ...
      Ship.keys().forEach(function(shipKey)
      {
         ...
         if (ship.primaryFiringArcKey === undefined && ship.fore === undefined)
         {
            ship.primaryFiringArcKey = FiringArc.FORWARD;
         }
