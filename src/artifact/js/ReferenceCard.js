...
define(function()
{
   var ReferenceCard = {
      ...
      BOMB_TOKENS_01: "bombTokens01",
      BOMB_TOKENS_02: "bombTokens02",
      BOMB_TOKENS_03: "bombTokens03",
      BOMB_TOKENS_04: "bombTokens04",
      BOMB_TOKENS_05: "bombTokens05",
      BOMB_TOKENS_06: "bombTokens06",
      BOMB_TOKENS_07: "bombTokens07",
      BOMB_TOKENS_08: "bombTokens08",
      ...
      properties:
      {
         "acquireATargetLockAction":
         {
            ...
            image: "../../../src/view/resource/referenceCard/Acquire_A_Target_Lock_Action.png",
            key: "acquireATargetLockAction",
         },
         "alternatePrimaryWeapons":
         {
            name: "Alternate Primary Weapons",
            image: "../../../src/view/resource/referenceCard/Alternate_Primary_Weapons.png",
            key: "alternatePrimaryWeapons",
         },
         "auxiliaryFiringArc":
         {
            name: "Auxiliary Firing Arc",
         ...
         "barrelRollAction":
         {
            ...
            image: "../../../src/view/resource/referenceCard/Barrel_Roll_Action.png",
         ...
         {
            name: "Evade Action",
            image: "../../../src/view/resource/referenceCard/Evade_Action.png",
            key: "evadeAction",
         },
         "focusAction":
         {
            name: "Focus Action",
            image: "../../../src/view/resource/referenceCard/Focus_Action.png",
            key: "focusAction",
         },
         "ionToken":
         {
         ...
         {
            name: "Stress Token",
            image: "../../../src/view/resource/referenceCard/Stress_Token.png",
            key: "stressToken",
         },
         "tallonRoll":
         {
         ...
         "theCombatPhase":
         {
            ...
            image: "../../../src/view/resource/referenceCard/The_Combat_Phase.png",
            key: "theCombatPhase",
         },
         "theGameRound":
         {
            name: "The Game Round",
            image: "../../../src/view/resource/referenceCard/The_Game_Round.png",
            key: "theGameRound",
         },
         "titles":
         {
   ...
   ReferenceCard.keys = function()
   {
      return Object.keys(ReferenceCard.properties);
   };

   ReferenceCard.values = function()
   {
      return Object.values(ReferenceCard.properties);
   };

   //////////////////////////////////////////////////////////////////////////
   // Utility methods.

   ReferenceCard.toString = function()
   {
