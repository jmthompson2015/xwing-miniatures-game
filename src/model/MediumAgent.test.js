...
define(["qunit", "redux",
  "artifact/DamageCard", "artifact/DiceModification", "artifact/Faction", "artifact/Maneuver", "artifact/Phase", "artifact/PilotCard", "artifact/ShipAction", "artifact/UpgradeCard",
  "model/Ability", "model/Action", "model/Adjudicator", "model/Agent", "model/CombatAction", "model/Environment", "model/EnvironmentAction", "model/MediumAgentStrategy", "model/PilotAbility3", "model/Position", "model/Reducer", "model/ShipActionAbility", "model/Squad", "model/TargetLock", "model/CardInstance", "model/CardAction",
  "model/EnvironmentFactory", "model/MockAttackDice", "model/MockDefenseDice"],
