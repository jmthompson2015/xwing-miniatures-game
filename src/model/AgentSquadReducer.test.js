...
define(["qunit", "artifact/PilotCard", "artifact/UpgradeCard",
  "model/AgentSquadAction", "model/AgentSquadInitialState", "model/AgentSquadReducer"],
   function(QUnit, PilotCard, UpgradeCard, AgentSquadAction, AgentSquadInitialState, AgentSquadReducer)
   {
