...
define(["qunit", "artifact/DiceModification",
  "model/Action", "model/AttackDice", "model/CombatAction", "model/DefenseDice", "model/ModifyDiceAbility", "model/TargetLock", "model/CardAction",
