...
define(["qunit", "artifact/Phase",
  "model/Action", "model/Adjudicator", "model/CombatAction", "model/CardAction", "model/UpgradeAbility4",
  "model/EnvironmentFactory", "model/MockAttackDice", "model/MockDefenseDice"],
   function(QUnit, Phase,
      Action, Adjudicator, CombatAction, CardAction, UpgradeAbility,
