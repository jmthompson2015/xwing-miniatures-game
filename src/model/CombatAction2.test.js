...
define(["qunit", "redux",
  "artifact/Faction", "artifact/Phase", "artifact/PilotCard", "artifact/Range", "artifact/UpgradeCard",
  "model/Ability", "model/Action", "model/Adjudicator", "model/Agent", "model/AttackDice", "model/CardAction", "model/CardInstance", "model/CombatAction", "model/DefenseDice", "model/Environment", "model/EnvironmentAction", "model/EventObserver",
  "model/PhaseObserver", "model/Position", "model/Reducer", "model/Selector", "model/Squad", "model/TargetLock", "model/UpgradeAbility3",
