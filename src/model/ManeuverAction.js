...
define(["immutable", "utility/InputValidator",
  "artifact/Bearing", "artifact/Maneuver", "artifact/PilotCard", "artifact/PlayFormat",
  "model/Action", "model/CardAction", "model/ManeuverComputer", "model/Position", "model/ShipFledAction"],
