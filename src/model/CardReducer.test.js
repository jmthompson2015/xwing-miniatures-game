...
define(["qunit", "redux",
  "artifact/Count", "artifact/DamageCard", "artifact/Phase", "artifact/PilotCard", "artifact/ShipAction", "artifact/UpgradeCard",
  "model/Ability", "model/Agent", "model/CardAction", "model/CardInstance", "model/DamageAbility3", "model/EnvironmentAction", "model/PilotAbility3", "model/Position", "model/Reducer", "model/ShipActionAbility", "model/UpgradeAbility3"],
