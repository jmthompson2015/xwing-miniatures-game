...
define(["qunit", "redux",
  "artifact/Maneuver", "artifact/PilotCard", "artifact/Faction", "artifact/UpgradeCard",
  "model/Action", "model/ActivationAction", "model/Adjudicator", "model/Agent", "model/CardAction", "model/CardInstance", "model/Environment", "model/EventObserver", "model/PhaseObserver", "model/Position", "model/Reducer", "model/Squad", "model/SquadBuilder",
