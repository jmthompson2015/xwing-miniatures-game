...
define(["qunit", "redux",
  "artifact/DamageCard", "artifact/Phase", "artifact/PilotCard", "artifact/Faction", "artifact/UpgradeCard",
   "model/Ability", "model/Action", "model/Adjudicator", "model/Agent", "model/AttackDice", "model/CombatAction", "model/DefenseDice", "model/Environment", "model/EnvironmentAction", "model/EventObserver", "model/PhaseObserver", "model/Position", "model/Reducer", "model/Selector", "model/Squad", "model/TargetLock", "model/CardInstance", "model/CardAction", "model/UpgradeAbility3",
   "model/MockAttackDice", "model/MockDefenseDice"],
