...
define(["qunit", "redux", "artifact/Event", "artifact/Maneuver", "artifact/Ship",
  "model/Action", "model/ActivationAction", "model/Adjudicator", "model/ManeuverAction", "model/Position", "model/SquadBuilder", "model/UpgradeAbility0",
