...
define(["qunit", "redux", "artifact/DamageCard", "artifact/PilotCard", "artifact/UpgradeCard",
  "model/Action", "model/Adjudicator", "model/Agent", "model/CardInstance", "model/Engine", "model/Environment", "model/EventObserver", "model/PhaseObserver", "model/Position", "model/Reducer", "model/SquadBuilder", "model/CardAction",
