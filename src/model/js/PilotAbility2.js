...
define(["common/js/InputValidator",
  "artifact/js/Bearing", "artifact/js/Maneuver", "artifact/js/Phase", "artifact/js/PilotCard", "artifact/js/UpgradeCard",
  "model/js/Action", "model/js/ActivationAction"],
