...
define(["immutable", "common/js/InputValidator", "artifact/js/Event", "artifact/js/ShipAction", "model/js/Action"],
   function(Immutable, InputValidator, Event, ShipAction, Action)
   {
