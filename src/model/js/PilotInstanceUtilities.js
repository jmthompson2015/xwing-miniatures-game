...
define(["common/js/ArrayUtilities", "common/js/InputValidator",
  "artifact/js/Bearing", "artifact/js/DamageCard", "artifact/js/Difficulty", "artifact/js/FiringArc", "artifact/js/Maneuver", "artifact/js/PilotCard", "artifact/js/Range", "artifact/js/ShipAction", "artifact/js/UpgradeCard",
  "model/js/Weapon"],
   function(ArrayUtilities, InputValidator, Bearing, DamageCard, Difficulty, FiringArc, Maneuver, PilotCard, Range, ShipAction, UpgradeCard, Weapon)
   {
