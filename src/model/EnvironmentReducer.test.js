...
define(["qunit", "redux",
  "artifact/CardType", "artifact/DamageCard", "artifact/PilotCard", "artifact/PlayFormat",
  "model/Agent", "model/EnvironmentAction", "model/Position", "model/Reducer", "model/SquadBuilder", "model/CardInstance",
