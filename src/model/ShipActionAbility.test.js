...
define(["qunit", "artifact/Maneuver", "artifact/ShipAction",
  "model/Action", "model/CombatAction", "model/Position", "model/ShipActionAbility", "model/TargetLock", "model/CardAction",
