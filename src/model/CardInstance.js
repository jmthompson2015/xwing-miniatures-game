...
define(["immutable", "utility/ArrayUtilities", "utility/InputValidator",
  "artifact/Bearing", "artifact/CardResolver", "artifact/CardType", "artifact/ConditionCard", "artifact/Count", "artifact/DamageCard", "artifact/Difficulty", "artifact/Event", "artifact/Faction", "artifact/FiringArc", "artifact/Maneuver", "artifact/PilotCard", "artifact/Range", "artifact/ShipAction", "artifact/ShipBase", "artifact/UpgradeCard", "artifact/UpgradeType", "artifact/Value",
  "model/Ability", "model/Action", "model/AgentAction", "model/CardAction", "model/DamageDealer", "model/PilotInstanceUtilities", "model/RangeRuler", "model/TargetLock", "model/Weapon"],
