...
define(["immutable", "qunit", "redux",
   "artifact/Event", "artifact/Maneuver", "artifact/Phase", "artifact/PilotCard", "artifact/Range",
  "model/Action", "model/Agent", "model/AttackDice", "model/DefenseDice", "model/EnvironmentAction", "model/Position", "model/Reducer", "model/TargetLock", "model/CardInstance"],
