...
define(["react", "react-dom", "common/js/InputValidator", "artifact/js/Phase", "model/js/AttackDice", "model/js/DefenseDice", "model/js/Selector", "model/js/SimpleAgent",
  "view/js/AbilityChooser", "view/js/CombatUI", "view/js/PlanningPanel", "view/js/WeaponAndDefenderChooser"],
   function(React, ReactDOM, InputValidator, Phase, AttackDice, DefenseDice, Selector, SimpleAgent, AbilityChooser, CombatUI, PlanningPanel, WeaponAndDefenderChooser)
   {
      function HumanAgent(name, factionKey, inputAreaId, resourceBase)
      {
         ...
         this.getPlanningAction = function(environment, adjudicator, callback)
         {
            ...
            var tokens = environment.getTokensForFaction(factionKey);
      ...
      HumanAgent.prototype.finishChooseAbility = function(ability, isAccepted)
      {
      ...
      {
         return this.name() + ", HumanAgent, " + this.factionKey();
      };
