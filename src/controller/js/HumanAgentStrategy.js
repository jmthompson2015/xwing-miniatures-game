...
define(["react", "react-dom", "common/js/ArrayAugments", "common/js/InputValidator", "artifact/js/Phase",
  ...
  "view/js/AbilityChooser", "view/js/CombatUI", "view/js/PlanningPanel", "view/js/WeaponAndDefenderChooser"],
   function(React, ReactDOM, ArrayAugments, InputValidator, Phase, AttackDice, DefenseDice, Selector, AbilityChooser, CombatUI, PlanningPanel, WeaponAndDefenderChooser)
   {
      var HumanAgentStrategy = {
         ...
         dealDamage: function(agent, attacker, weapon, attackDice, defender, defenseDice, damageDealer, callback)
         {
            InputValidator.validateNotNull("agent", agent);
            InputValidator.validateNotNull("attacker", attacker);
