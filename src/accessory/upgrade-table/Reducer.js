...
define(["common/js/ArrayUtilities", "common/js/InputValidator", "common/js/ObjectUtilities", "accessory/upgrade-table/Action", "accessory/upgrade-table/DefaultFilters", "accessory/upgrade-table/InitialState"],
