...
define(["create-react-class", "prop-types", "react", "react-dom-factories", "model/js/TargetLock", "view/js/CardInstancesArea", "view/js/ReactUtilities", "controller/js/CardImageContainer", "controller/js/TokenPanelContainer"],
