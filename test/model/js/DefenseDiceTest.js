...
define(["qunit", "redux", "artifact/js/DefenseDiceValue", "model/js/Action", "model/js/DefenseDice", "model/js/Reducer"],
   function(QUnit, Redux, DefenseDiceValue, Action, DefenseDice, Reducer)
   {
