...
define(["qunit", "redux", "artifact/js/AttackDiceValue", "model/js/AttackDice", "model/js/Reducer", "../../../test/model/js/MockAttackDice"],
   function(QUnit, Redux, AttackDiceValue, AttackDice, Reducer, MockAttackDice)
   {
