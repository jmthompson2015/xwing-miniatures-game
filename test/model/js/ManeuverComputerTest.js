...
define(["qunit", "artifact/js/Maneuver", "artifact/js/PlayFormat", "artifact/js/ShipBase",
  "model/js/ManeuverComputer", "model/js/Position"],
   function(QUnit, Maneuver, PlayFormat, ShipBase,
      ManeuverComputer, Position)
   {
