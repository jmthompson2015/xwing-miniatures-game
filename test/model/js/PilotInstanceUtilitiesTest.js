...
define(["qunit", "redux",
  "artifact/js/Bearing", "artifact/js/DamageCard", "artifact/js/Difficulty", "artifact/js/Faction", "artifact/js/Maneuver", "artifact/js/PilotCard", "artifact/js/Range", "artifact/js/Ship", "artifact/js/UpgradeCard",
  "model/js/Agent", "model/js/CardAction", "model/js/CardInstance", "model/js/PilotInstanceUtilities", "model/js/Environment", "model/js/EnvironmentAction", "model/js/Position", "model/js/Reducer", "model/js/Squad",
  "../../../test/model/js/EnvironmentFactory"],
   function(QUnit, Redux, Bearing, DamageCard, Difficulty, Faction, Maneuver, PilotCard, Range, Ship, UpgradeCard, Agent, CardAction, CardInstance, PilotInstanceUtilities, Environment, EnvironmentAction, Position, Reducer, Squad, EnvironmentFactory)
   {
