...
define(["qunit", "redux", "artifact/js/Maneuver", "artifact/js/PilotCard",
  "model/js/Action", "model/js/ActivationPhaseTask", "model/js/Adjudicator", "model/js/Agent", "model/js/Environment", "model/js/EventObserver", "model/js/PhaseObserver", "model/js/Reducer", "model/js/SquadBuilder", "model/js/CardAction",
