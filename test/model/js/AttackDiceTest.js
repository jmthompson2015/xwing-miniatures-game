...
define(["qunit", "redux", "artifact/js/AttackDiceValue", "model/js/Action", "model/js/AttackDice", "model/js/Reducer"],
   function(QUnit, Redux, AttackDiceValue, Action, AttackDice, Reducer)
   {
